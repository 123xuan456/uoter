...
public class PreferenceManager {
	...
	private static String SHARED_KEY_CURRENTUSER_USERPSW = "SHARED_KEY_CURRENTUSER_USERPSW";
	...
	public void setCurrentUserPsw(String psw){
		editor.putString(SHARED_KEY_CURRENTUSER_USERPSW, psw);
		editor.apply();
	}

	public String getCurrentUserpsw(){
		return mSharedPreferences.getString(SHARED_KEY_CURRENTUSER_USERPSW, null);
	}
