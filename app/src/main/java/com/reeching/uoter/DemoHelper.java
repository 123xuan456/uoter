...
import com.reeching.uoter.cache.UserCacheManager;
import com.reeching.uoter.conference.ConferenceActivity;
...
import com.reeching.uoter.doman.EmojiconExampleGroupData;
import com.reeching.uoter.doman.InviteMessage;
import com.reeching.uoter.doman.RobotUser;
import com.reeching.uoter.receiver.CallReceiver;
import com.reeching.uoter.ui.ChatActivity;
import com.reeching.uoter.ui.MainActivity;
import com.reeching.uoter.ui.VideoCallActivity;
import com.reeching.uoter.ui.VoiceCallActivity;
import com.reeching.uoter.utils.LogUtils;
import com.reeching.uoter.utils.PreferenceManager;
...
import static com.reeching.uoter.doman.InviteMessage.InviteMessageStatus.BEAGREED;
import static com.reeching.uoter.doman.InviteMessage.InviteMessageStatus.BEAPPLYED;
import static com.reeching.uoter.doman.InviteMessage.InviteMessageStatus.BEINVITEED;
import static com.reeching.uoter.doman.InviteMessage.InviteMessageStatus.GROUPINVITATION;
import static com.reeching.uoter.doman.InviteMessage.InviteMessageStatus.GROUPINVITATION_ACCEPTED;
import static com.reeching.uoter.doman.InviteMessage.InviteMessageStatus.GROUPINVITATION_DECLINED;
import static com.reeching.uoter.doman.InviteMessage.InviteMessageStatus.MULTI_DEVICE_CONTACT_ALLOW;
import static com.reeching.uoter.doman.InviteMessage.InviteMessageStatus.MULTI_DEVICE_CONTACT_BAN;
...
//        options.setImPort(31097);
    ...
    class MyGroupChangeListener implements EMGroupChangeListener {
        ...
        public void onInvitationAccepted(String groupId, String invitee, String reason) {
            ...
            msg.setStatus(GROUPINVITATION_ACCEPTED);
            notifyNewInviteMessage(msg);
            broadcastManager.sendBroadcast(new Intent(Constant.ACTION_GROUP_CHANAGED));
        }
        ...
        public void onInvitationDeclined(String groupId, String invitee, String reason) {
            ...
            msg.setStatus(GROUPINVITATION_DECLINED);
            notifyNewInviteMessage(msg);
            broadcastManager.sendBroadcast(new Intent(Constant.ACTION_GROUP_CHANAGED));
        }
...
//                break;
                case CONTACT_BAN:
                    updateContactNotificationStatus(target, "", MULTI_DEVICE_CONTACT_BAN);
                    ...
                    break;
                case CONTACT_ALLOW:
                    updateContactNotificationStatus(target, "", MULTI_DEVICE_CONTACT_ALLOW);
       ...
       new Thread(){
           ...
           public void run(){
               ...
               try {
                   ...
                   //张达服务器获取所有的好友
                   String token = PreferenceManager.getInstance().getCurrentUserToken();
                   LogUtils.i(token);

                 //从服务器获取登录用户在其他设备上登录的ID
//                   OkGo.<AllContactsBean>post(SENDFRIENDSLIST)
//                           .params("utoken",token)
//                           .params("targetType","users")
//                           .cacheKey(token)
//                           .cacheMode(CacheMode.FIRST_CACHE_THEN_REQUEST)
//                           .execute(new JsonCallback<AllContactsBean>(AllContactsBean.class) {
//                               @Override
//                               public void onStart(Request<AllContactsBean, ? extends Request> request) {
//                                   super.onStart(request);
//                               }
//
//                               @Override
//                               public void onSuccess(Response<AllContactsBean> response) {
//                                   AllContactsBean allContactsBean=response.body();
//                                   int result = allContactsBean.getResult();
//                                   if ("0".equals(result+"")){
//                                       List<AllContactsBean.ListBean> list = allContactsBean.getList();
...
//                                       dao.saveContactList(users);
//                                   }else {
//                                       LogUtils.i(allContactsBean.getMsg());
//                                   }
//                               }
//
//                               @Override
//                               public void onCacheSuccess(Response<AllContactsBean> response) {
//                                   super.onCacheSuccess(response);
//                                   onSuccess(response);
//                               }
//
//                               @Override
//                               public void onError(Response<AllContactsBean> response) {
//                                   super.onError(response);
//                                   LogUtils.i("获取失败"+response);
//                               }
//
//                               @Override
