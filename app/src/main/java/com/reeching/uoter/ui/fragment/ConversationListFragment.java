...
import com.reeching.uoter.ui.LoginActivity;
...
public class ConversationListFragment extends EaseConversationListFragment {
    ...
    protected void onConnectionDisconnected() {
        ...
        errorItemContainer.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        if (NetUtils.hasNetwork(getActivity())) {
            LogUtils.i(R.string.can_not_connect_chat_server_connection);
